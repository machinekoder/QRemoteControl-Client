...
Rectangle {
    ...
    LineEdit {
        ...
        text: value.toString()
        textColor: minusButton.textColor
        autodelete: false
        onTextChanged: {
    ...
    Button {
        ...
        border.width: minusButton.border.width
        border.color: minusButton.border.color
        defaultGradient: minusButton.defaultGradient
        hoveredGradient: minusButton.hoveredGradient
        pressedGradient: minusButton.pressedGradient
