...
Style {
    name:                 qsTr("Fancy Green") + client.emptyString
    themeName:            "fancygreen"
    backgroundImage:      "images/green_bees.jpg"
    ...
    highlightColor:          "#bfff7f"
    secondaryHighlightColor: "#aa99cc65"
