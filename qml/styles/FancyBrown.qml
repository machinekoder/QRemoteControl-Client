...
Style {
    name:                 qsTr("Fancy Brown") + client.emptyString
    themeName:            "fancybrown"
    backgroundImage:      "images/brown_bird.jpg"
    ...
    highlightColor:          "#ffc17f"
    secondaryHighlightColor: "#aacc9b65"
